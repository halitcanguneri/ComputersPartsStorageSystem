...
{
    public partial class ShowGPU : Form
    {
        public ShowGPU()
        {
            InitializeComponent();
        ...
        public void UrunleriGetir()
        {
            ...
            connection.Open();
            SqlDataAdapter dat = new SqlDataAdapter("select * from EkranKarti ", connection);
        ...
        private void ShowGPU_Load(object sender, EventArgs e)
        {
            UrunleriGetir();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            string connectionString = "Data Source=DESKTOP-C96P3S9\\SQL;Initial Catalog=ComputerPartsStorage;Integrated Security=True";
            SqlConnection connection = new SqlConnection(connectionString);
            string sorgu = "delete from EkranKarti where UrunID=@UrunID";
        ...
        private void ShowGPU_Load_1(object sender, EventArgs e)
        {
            UrunleriGetir();
            SqlDataAdapter adtr = new SqlDataAdapter("select * from EkranKarti ", connection5);
            adtr.Fill(dt);
