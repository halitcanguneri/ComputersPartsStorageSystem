...
{
    public partial class ShowRAMForUsers : Form
    {
        ...
        public ShowRAMForUsers()
        {
            InitializeComponent();
            UrunleriGetir();
            SqlDataAdapter adtr = new SqlDataAdapter("select * from RAM ", connection5);
            adtr.Fill(dt);
        ...
        private void ShowRAMForUsers_Load(object sender, EventArgs e)
        {
