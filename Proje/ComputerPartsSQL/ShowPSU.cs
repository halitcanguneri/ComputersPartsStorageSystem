...
{
    public partial class ShowPSU : Form
    {
        public ShowPSU()
        {
            InitializeComponent();
        ...
        public void UrunleriGetir()
        {
            ...
            connection.Open();
            SqlDataAdapter dat = new SqlDataAdapter("select * from PSU ", connection);
        ...
        private void ShowPSU_Load(object sender, EventArgs e)
        {
            UrunleriGetir();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            string connectionString = "Data Source=DESKTOP-C96P3S9\\SQL;Initial Catalog=ComputerPartsStorage;Integrated Security=True";
            SqlConnection connection = new SqlConnection(connectionString);
            string sorgu = "delete from PSU where UrunID=@UrunID";
        ...
        private void ShowPSU_Load_1(object sender, EventArgs e)
        {
            UrunleriGetir();
